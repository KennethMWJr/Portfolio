        ...
        <div>
            ...
            <div>
                ...
                <div className= "project-card">
                    ...
                    <p className= "description">A React App using a Pixabay API to render photos and videos of nature.  </p>
                </div>
                <div className= "project-card">
                    ...
                    <p className= "description">A full stack app applying full CRUD with React and Ruby on Rails.</p>
                </div>
            </div>
        </div>
